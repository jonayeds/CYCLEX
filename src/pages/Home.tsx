...
import BicycleQueries from "../components/home/BicycleQueries"
    ...
    <div className="">
        <div className="h-screen overflow-hidden relative w-screen z-30 hero-background " >
          <div className="absolute w-full h-full bg-black opacity-20 z-10"></div>
            <h1 className="absolute top-[30vh] text-[4vw] text-white  font-main font-bold z-40 text-center   transform translate-x-1/3">Find Your Perfect Ride <br /> Unleash the Joy of Cycling!</h1>
        </div>
        <div>
